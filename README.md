...
- Developed a real-time fluttering flag simulation using OpenGL (GLEW + FreeGLUT) with dynamic sine-wave deformation of a high-resolution mesh (~0.25M vertices).
